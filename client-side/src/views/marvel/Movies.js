...
class Movies extends React.Component {
    state = {
        ...
        items:[
            ...
            {status: "No", order: 6, img: "", movie: "Thor: The Dark World", year: 2013, description: "Here’s where the order of events really changes, but for good reason. The last two films have explored the cosmic side of the MCU, and it makes sense to continue that line. Some of the most important themes and ideas — particularly the relationship between Thor and Loki — follow on perfectly from THE AVENGERS. This also introduces the idea of the Infinity Stones, although they’re only partly explained at this point."},
            {status: "No", order: 7, img: "", movie: "Guardians of the Galaxy", year: 2014, description: "Continuing the cosmic focus, GUARDIANS OF THE GALAXY unveils another Infinity Stone. The Collector, introduced in the stinger of THOR: THE DARK WORLD, makes another appearance, tying the two films together. Viewers are left with a strong sense that the Infinity Stones are being brought into play across the universe."},
            {status: "No", order: 8, img: "", movie: "Guardians of the Galaxy Vol. 2", year: 2017, description: "The events of GUARDIANS OF THE GALAXY VOL. 2 are set only a couple of months after the first film, so it makes sense for this to follow straight on. It continues the space-opera style and tone established by the last two films in our Marvel movie order."},
            {status: "No", order: 9, img: "", movie: "Iron Man 3", year: 2013, description: "The cosmic diversion is over, and the focus now moves back to Earth, where Tony Stark is dealing with the emotional fallout from THE AVENGERS. The passage of time between the films actually makes Tony’s PTSD feel more significant, while also making it feel more natural that Stark has had the time to build so many armors."},
            {status: "No", order: 10, img: "", movie: "Captain America: The Winter Soldier", year: 2014, description: "Continuing with the Earthly focus, this movie shows what Captain America is up to. This story could even be happening at the same time as IRON MAN 3, explaining why Cap doesn’t help Tony against the Mandarin and why Stark isn’t on hand to deal with Hydra. Or maybe Cap and Stark are merely still wary of one another at this stage. Perhaps most importantly, placing this film here begins a Falcon arc that will run through the next few movies."},
            {status: "No", order: 11, img: "", movie: "Avengers: Age of Ultron", year: 2015, description: "This is another natural fit. The film opens with the Avengers taking down a major Hydra base. In thematic terms, placing this close to IRON MAN 3 makes Tony’s emotional journey feel more immediate and natural. This film also begins to tie the Earth-bound adventures into the cosmic stories, with another Infinity Stone revealed. Thor’s vision establishes a sense of impending threat."},
            {status: "No", order: 12, img: "", movie: "Ant-Man", year: 2015, description: "Set in the immediate aftermath of AVENGERS: AGE OF ULTRON, ANT-MAN contains subtle references to the devastation at Sokovia. Placing it here in the lineup makes the Falcon fight carry additional weight, bringing Sam closer to primary character status."},
            {status: "No", order: 13, img: "", movie: "Captain America: Civil War", year: 2016, description: "The Sokovia arc that begun in AVENGERS: AGE OF ULTRON comes to a head in CAPTAIN AMERICA: CIVIL WAR, tearing the Avengers apart. CIVIL WAR acts as the launchpad for the next batch of Earth-bound stories, so they slot in nicely after it. It also follows on perfectly from ANT-MAN’s end-credits scene."},
            {status: "No", order: 14, img: "", movie: "Black Panther", year: 2018, description: "Black Panther was introduced in CIVIL WAR, and this continues his story. It’s appropriate to drop this movie in next, as BLACK PANTHER is set only a week after the Avengers divide, and the Wakandan focus follows on nicely from the end-credits sequence."},
            {status: "No", order: 15, img: "", movie: "Spider-Man: Homecoming", year: 2017, description: "Set two months after CIVIL WAR, SPIDER-MAN: HOMECOMING focuses on Peter Parker. It’s important to note that Tony Stark has been given time to heal a little, so this viewing order makes sense."},
            {status: "No", order: 16, img: "", movie: "Doctor Strange", year: 2016, description: "Placing DOCTOR STRANGE here gives the film real importance as a thematic tie between the MCU’s Earth-bound and cosmic movies. DOCTOR STRANGE introduces the concept of magic and brings the Time Stone into play. The Quantum Realm also plays a subtle role, as Strange glimpses it while being sent careering through the dimensions. Finally, the end-credits scene leads nicely into THOR: RAGNAROK."},
            {status: "No", order: 17, img: "", movie: "Thor: Ragnarok", year: 2017, description: "This film follows on logically from DOCTOR STRANGE. (There’s even a cameo.) The end credits begin the direct buildup to AVENGERS: INFINITY WAR, with the Asgardian refugees intercepted in space by Thanos."},
            {status: "No", order: 18, img: "", movie: "nt-Man and the Wasp", year: 2018, description: "This is a difficult one to place in this thematic structure. While it returns to the Earth-bound adventures, ANT-MAN AND THE WASP is fantastical and funny. The bulk of the story is set before the events of AVENGERS: INFINITY WAR, so it makes sense to place it here. This particular viewing order does change how the post-credits scene plays, however. Rather than knowing what’s going on, you’ll have the same sense of shock and horror felt by Hank Pym or Scott Lang."},
            {status: "No", order: 19, img: "", movie: "Avengers: Infinity War ", year: 2018, description: "In this order, AVENGERS: INFINITY WAR will be the last thing you watch before AVENGERS: ENDGAME. That works particularly well when you consider that, according to screenwriters Christopher Markus and Stephen McFeely, the snap was originally in ENDGAME. These two films may not be a traditional Parts I and II anymore, but their relationship is so close that it’s better to watch them back to back — just how they were filmed."},
            {status: "No", order: 20, img: "", movie: "Avengers: Endgame ", year: 2019, description: "It’s no surprise that ENDGAME is definitely the wrap-up to any MCU viewing party, at least for the time being. The world reels from the aftereffects of Thanos’s snap, and our heroes are just as affected as everyone else, if not more so. The fourth AVENGERS movie is very much the culmination of 10 years of story — it is deeply tied to everything that came before, particularly the first three AVENGERS movies. (That’s a hint about which movies you should definitely rewatch, if you only have time for a handful.) The story ties up a handful of plot threads that began in several previous movies and opens up new dimensions for future MCU movies to explore."},
            {status: "No", order: 21, img: "", movie: "Spider-Man: Far From Home", year: 2011, description: "Marvel’s second SPIDER-MAN movie very specifically follows ENDGAME, as it explores Peter’s grief over the passing of Tony Stark and the changes wrought on the world. It’s somewhere between a coda to the last storytelling phase in the MCU and, thanks to the final moments of the movie, a pointer to where Marvel is likely to go next"}
            ]
        }
            ...
            <>
                ...
                <div id="stars"></div>
                    ...
                    {this.state.items.map((items, index) => (
                        ...
                        <Row>
                            <Card > <strong></strong>
                                <CardImg class="card-image" top width="100%" src={items.img} alt="Card image cap" />
                                    <CardBody>
                                    ...
                                    <Button onClick={this.handleEvent}>Watched it yet? {items.status}</Button>
                                </CardBody>
                            </Card>
                        </Row>
                    </div>
